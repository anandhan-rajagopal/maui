...
public class FlexLayoutFeatureTests : UITest
{
    ...
    [Test, Order(7)] // space-between not working
    ...
    [Test, Order(12)] //SpaceAround not working. BoxView disappears
    ...
    [Test, Order(13)] // SpaceBetween not working. BoxView disappears
    ...
    public void FlexLayout_Child1Shrink()
    {
        ...
        App.EnterText("Child1ShrinkEntry", "50");
        App.WaitForElement("Apply");
        App.Tap("Apply");
        App.WaitForElementTillPageNavigationSettled("Child1ShrinkLabel");
        Assert.That(App.FindElement("Child1ShrinkLabel").GetText(), Is.EqualTo("50"));
        VerifyScreenshot();
    }
    ...
    // Basis property with Directions
