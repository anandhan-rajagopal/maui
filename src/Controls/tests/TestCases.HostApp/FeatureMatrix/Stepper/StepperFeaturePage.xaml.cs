...
namespace Maui.Controls.Sample
{
    public partial class StepperFeaturePage : ContentPage
    {
        ...
        {
            if (BackgroundColorTransparentRadio.IsChecked)
                _viewModel.BackgroundColor = Colors.Transparent;
            else if (BackgroundColorRedRadio.IsChecked)
                _viewModel.BackgroundColor = Colors.Red;
            else if (BackgroundColorBlueRadio.IsChecked)
                _viewModel.BackgroundColor = Colors.Blue;
            else if (BackgroundColorGreenRadio.IsChecked)
